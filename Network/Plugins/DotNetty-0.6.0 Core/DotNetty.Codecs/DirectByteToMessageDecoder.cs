...
namespace DotNetty.Codecs
{
    ...
    public abstract class DirectByteToMessageDecoder : ChannelHandlerAdapter
    {
        ...
        protected IByteBuffer InternalBuffer
        {
            get
            {
                ...
                {
                    return PooledByteBufferAllocator.Default.DirectBuffer();
                }
            }
        }
        ...
        static IByteBuffer ExpandCumulation(IByteBufferAllocator allocator, IByteBuffer cumulation, int readable)
        {
            ...
            cumulation = allocator.DirectBuffer(oldCumulation.ReadableBytes + readable);
        ...
        public override void ChannelRead(IChannelHandlerContext context, object message)
        {
            ...
            if (data != null)
            {
                ...
                try
                {
                    ...
                    {
                        this.cumulation = this.cumulator(PooledByteBufferAllocator.Default, this.cumulation, data);
                    }
